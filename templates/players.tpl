        ...
        <tbody>
            {foreach from=$players item=$player}
                <tr>
                    ...
                    <td>
                        <a href='edit/{$player->id_pk}' type='button' class="btn btn-primary btn-sm">
                    ...
                    <td>
                        <a href='delete/{$player->id_pk}' type='button' class="btn btn-danger btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
